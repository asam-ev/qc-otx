...
CHECKER_ID = "check_asam_otx_state_machine_chk_004_mandatory_trigger"
CHECKER_DESCRIPTION = (
    "Each state except the completed state shall have at least one trigger."
)
CHECKER_PRECONDITIONS = set()
RULE_UID = "asam.net:otx:1.0.0:state_machine.chk_004.mandatory_trigger"
        ...
        for sm_state in state_machine.states:
            ...
            if has_issue:
                ...
                issue_id = checker_data.result.register_issue(
                    checker_bundle_name=constants.BUNDLE_NAME,
                    checker_id=CHECKER_ID,
                    description="Non completed state has no triggers",
